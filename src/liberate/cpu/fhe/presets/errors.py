...
class LevelError(Exception):
    def __init__(self, cipher_text_level, dst_level):
        self.message_error = f""" The level of the destination must be higher than the level of the ciphertext.
        dst level : {dst_level:2d}, now : {cipher_text_level:2d}""".strip()
